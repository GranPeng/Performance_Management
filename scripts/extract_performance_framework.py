...
def main():
    ...
    rules += ["","## 提成与激励规则索引","", "- 兴趣电商运营、高级主管：运营店铺 GSV 的得分梯度，提成基数由 Commission_Tier.Base_Rate 配置读取，系数按分段取值；完整下限、上限、系数与公式见结构化规则文档。","- 广告投放：投放账户广告消耗的得分分段提成比例均为0.001（源表列为100分前的四档）。","- 直播中控/运营助理：源表将“0.1%/中控人数”与“绩效工资×80%/90%/100%/110%”并列记录，列映射待确认。","- 主播：个人直播时段 GSV，源表列示0~60/60~80/80~100/100~150分对应0.001/0.002/0.004/0.005。","- 客服：提成按各 KPI 奖励条件及金额为准，源表无统一梯度或得分换算公式。","- 编导、视频剪辑：近90天内上传素材单视频消耗超50万为爆款；除消耗提成外额外一次性奖励1500元/片。","- 摄影师：个人拍摄素材消耗的四档提成比例见结构化规则文档。","","## 争议项（禁止自行补充）",""]
...
| 提成基数 | — | 兴趣电商运营与高级主管的比例基数；运行时从 Commission_Tier.Base_Rate 配置读取。 | 同上，运营/高级主管表 |
